    ...
    public partial class Form1 : Form
    {
        ...
        public void TrackAircraft()
        {
            if (!GlobalVariables.targetBox.Width.Equals(0))
            {
                ...
                Emgu.CV.VideoCapture capture1 = new Emgu.CV.VideoCapture("rtsp://user:password@192.168.1.1:554/Streaming/Channels/102/");
        ...
        {
            {
                Emgu.CV.VideoCapture capture = new Emgu.CV.VideoCapture("rtsp://user:password!@192.168.1.1:554/Streaming/");
                int i = 0;
